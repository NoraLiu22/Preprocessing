...
// This class is NOT thread-safe! If you have more than one thread, each thread should get its own instance.
      ...
      try {
        ...
        while (true) {
          ...
          if (!readingHeaders) {
            ...
            if ((buffer.size() >= contentLength) || isHeadRequest)
              break;
          }
        }
      } catch (Exception e) {
